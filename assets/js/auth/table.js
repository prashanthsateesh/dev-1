...
$.extend(true, $.fn.dataTable.defaults, {
    "sDom": "<'row'<'col-xs-6'l><'col-xs-6'f>r>" +
        "t" +
        "<'row'<'col-xs-6 text-danger'i><'col-xs-6'p>>",
    "oLanguage": {
    ...
    var r = function(n) {
            ...
            receiveEvent: function(a, b) {
                ...
                if (this.handlers[a])
                    for (var d = 0, f = this.handlers[a].length; d <
                        ...
                        else if ("string" == typeof e) m[e](this, b)
                    }
            }
        };
        ...
        TableTools.prototype = {
            ...
            fnCalcColRatios: function(a) {
                var b = this.s.dt.aoColumns,
                    ...
                    e, j;
                e = 0;
                for (j = a.length; e < j; e++) a[e] && (d = b[e].nTh.offsetWidth, f += d, c.push(d));
                e = 0;
                for (j = c.length; e < j; e++) c[e] /= f;
                return c.join("\t")
            },
                ...
                if (this.s.master) {
                    ...
                    e(b.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function(c) {
                        var d = this.nodeName.toLowerCase() === "tr" ? this : e(this).parents("tr")[0],
                            f = a.s.select,
                            i = a.s.dt.oInstance.fnGetPosition(d);
                        if (d.parentNode ==
                            ...
                            if (f.type == "os")
                                ...
                                var j = a.s.dt.aiDisplay.slice(),
                                    ...
                                    o = e.inArray(i, j);
                                if (a.fnGetSelected().length === 0 || h === -1) j.splice(e.inArray(i, j) + 1, j.length);
                                else {
                                    if (h > o) var g = o,
                                        o = h,
                                        h = g;
            ...
            _fnRowSelect: function(a, b) {
                var c = this._fnSelectData(a),
                    ...
                    f, i;
                f = 0;
                for (i = c.length; f < i; f++) c[f].nTr && d.push(c[f].nTr);
                if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this, b, d, !0)) {
                    f = 0;
                    for (i = c.length; f < i; f++) c[f]._DTTT_selected = !0, c[f].nTr && e(c[f].nTr).addClass(this.classes.select.row);
            ...
            _fnRowDeselect: function(a, b) {
                ...
                if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this,
                    b, d, !1)) {
                    f = 0;
                    for (i = c.length; f < i; f++) c[f]._DTTT_selected = !1, c[f].nTr && e(c[f].nTr).removeClass(this.classes.select.row);
            ...
            _fnColumnTargets: function(a) {
                ...
                if ("object" == typeof a) {
                    d = 0;
                    for (f = c.aoColumns.length; d < f; d++) b.push(!1);
                    d = 0;
                    for (f = a.length; d < f; d++) b[a[d]] = !0
                } else if ("visible" == a) {
                    d = 0;
                    for (f = c.aoColumns.length; d < f; d++) b.push(c.aoColumns[d].bVisible ? !0 : !1)
                } else if ("hidden" == a) {
                    d = 0;
                    for (f = c.aoColumns.length; d <
                        f; d++) b.push(c.aoColumns[d].bVisible ? !1 : !0)
                } else if ("sortable" == a) {
                    d = 0;
                    for (f = c.aoColumns.length; d < f; d++) b.push(c.aoColumns[d].bSortable ? !0 : !1)
                } else {
                    d = 0;
                    for (f = c.aoColumns.length; d < f; d++) b.push(!0)
                }
                return b
            },
            ...
            _fnGetDataTablesData: function(a) {
                var b, c, d, f, i, j = [],
                    ...
                    n = "undefined" != typeof a.bSelectedOnly ? a.bSelectedOnly :
                    !1;
                if (a.bHeader) {
                    i = [];
                    b = 0;
            ...
            _fnPrintStart: function(a) {
                ...
                for (f in d)
                    if ("i" != f && "t" != f && 1 == f.length)
                        for (var i = 0, g = d[f].length; i < g; i++) this.dom.print.hidden.push({
                            node: d[f][i],
                            display: "block"
                        }), d[f][i].style.display = "none";
        ...
        "function" == typeof e.fn.dataTable && "function" == typeof e.fn.dataTableExt.fnVersionCheck && e.fn.dataTableExt.fnVersionCheck("1.9.0") ?
            e.fn.dataTableExt.aoFeatures.push({
                fnInit: function(a) {
                    var b = a.oInit,
                        a = new TableTools(a.oInstance, b ? b.tableTools || b.oTableTools || {} : {});
...
(function(j, i, k) {
        ...
        e.prototype = {
            ...
            _fnDrawCallback: function() {
                ...
                for (f = c.length; b < f; b++) {
                    ...
                    if (g) d("input", this.dom.groupButtons[b]).prop("checked", !0), d("input", this.dom.groupButtons[b]).prop("indeterminate", !1);
                    else {
                        a: {
                            g = c[b].aiColumns;
                            h = 0;
            ...
            _fnAddButtons: function() {
                ...
                this.s.showAll && (a = this._fnDomShowAllButton(), a.className += " ColVis_ShowAll", this.dom.buttons.push(a));
                d(this.dom.collection).append(this.dom.buttons)
            },
            _fnDomRestoreButton: function() {
                var a = this;
                return d('<li class="ColVis_Special ' +
                    (this.s.dt.bJUI ? "ui-button ui-state-default" : "") + '">' + this.s.restore + "</li>").click(function() {
            ...
            _fnDomShowAllButton: function() {
                var a = this;
                return d('<li class="ColVis_Special ' + (this.s.dt.bJUI ? "ui-button ui-state-default" : "") + '">' + this.s.showAll + "</li>").click(function() {
                    for (var b = 0, c = a.s.abOriginal.length; b <
                        c; b++) - 1 === a.s.aiExclude.indexOf(b) && a.s.dt.oInstance.fnSetColumnVis(b, !0, !1);
                    a._fnAdjustOpenRows();
                    a.s.dt.oInstance.fnAdjustColumnSizing(!1);
                    a.s.dt.oInstance.fnDraw(!1)
                })[0]
            ...
            _fnDomColumnButton: function(a) {
                ...
                return d("<li " + (f.bJUI ? 'class="ui-button ui-state-default"' : "") + '><label><input type="checkbox" /><span>' + c + "</span></label></li>").click(function(c) {
                    ...
                    d.fn.dataTableExt.iApiIndex =
                        b._fnDataTablesApiIndex.call(b);
            ...
            _fnDomBackground: function() {
                var a = this,
                    b = d("<div></div>").addClass("ColVis_collectionBackground").css("opacity",
                        0).click(function() {
                        a._fnCollectionHide.call(a, null, null)
                    });
            ...
            _fnCollectionShow: function() {
                ...
                this.s.bCssPosition || (b = "left" == this.s.sAlign ? e : e - d(c).outerWidth() +
                    d(this.dom.button).outerWidth(), c.style.left = b + "px", f = d(c).outerWidth(), d(c).outerHeight(), e = d(i).width(), b + f > e && (c.style.left = e - f + "px"));
                this.s.hidden = !1
            },
    ...
    "function" === typeof define && define.amd ? define("datatables-colvis", ["jquery", "datatables"], j) : jQuery && !jQuery.fn.dataTable.ColVis && j(jQuery, jQuery.fn.dataTable)
})(window, document);
