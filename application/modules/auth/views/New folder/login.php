...
<div class="well google-well">
  ...
  <!--<span class="text-danger">Do not use email id to login. Please use your username only.</span>-->
...
<div class="form-group">
  <small> 
    <a  class="text-info" href="<?php echo base_url('auth/forgot_password') ?>">Forgot password or username? (active)</a>
    <br>
...
<h4 class='text-center'>Current Time : <?php echo $date;?></h4>
